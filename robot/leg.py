...
class Leg:
    ...
    def set_home(self):
        ...
        if self.simulate == True:
            ...
            self.home=(self.joint_0_pos,self.joint_1_pos)
            print(self.home)
            #return(home)
    ...
    def set_joint_pos(self, theta0, theta1, vel0=0, vel1=0, curr0=0, curr1=0):
        ...
        if self.simulate == True:
            ...
            self.m1.pos_setpoint=theta1*2048*4/(2*pi)-pi/2
    ...
    def compute_internal_angles(self, theta_0, theta_1):
        ...
        alpha8=acos((l1**2+l6**2-l5**2)/(2*l6*l2));
    ...
    def draw_leg(self,ax=False):
        ...
        (alpha2, alpha1)= self.compute_internal_angles(theta1,theta2)
